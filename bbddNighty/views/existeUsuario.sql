...
ur.email as ur_email, ur.logInWith as ur_logInWith, ur.id as ur_id
from emails e inner join emailsPersona ep ON e.id = ep.email inner join usuarios u on u.persona = ep.persona right join usuariosregistrandose ur on true;